import { Money, MoneyConverters } from '@commercetools/connect-payments-sdk';
...
export const convertCoCoAmountToPayPalAmount = (amountToConvert: Money, fractionDigits: number): string => {
  ...
  const amount = MoneyConverters.convert(amountToConvert.centAmount, negativeFractionDigits);
